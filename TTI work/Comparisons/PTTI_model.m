function result=PTTI_model(time_values,test_values,trace_values, parameter_values)
...
%% Initialize
 ...
 %%Initial conditions
    IC=[unknown known contact_trace test trace Total_traced parameter_values]; % S I u tswitch
